...
curl -L -o ~/.cluster-api/clusterctl.yaml \
  https://github.com/weimantian/cloudnative-cluster-api-provider-cce/raw/main/release/clusterctl.yaml
...
curl -L -o /tmp/cert-manager.yaml \
  https://github.com/weimantian/cloudnative-cluster-api-provider-cce/raw/main/release/cert-manager.yaml
...
curl -L -O https://github.com/weimantian/cloudnative-cluster-api-provider-cce/raw/main/config/samples/cluster-template.yaml
curl -L -O https://github.com/weimantian/cloudnative-cluster-api-provider-cce/raw/main/config/samples/cluster-template-standard.yaml
curl -L -O https://github.com/weimantian/cloudnative-cluster-api-provider-cce/raw/main/config/samples/cluster-template-turbo.yaml
