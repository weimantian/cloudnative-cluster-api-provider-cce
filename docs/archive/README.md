...
> 归档日期：2026-08-22
> 本目录存放开发过程中产生的**历史文档、研究资料与过程记录**。当前活跃文档见 `docs/` 根目录，最新对标状态见 [`capa-alignment-summary-2026-08-22.md`](../capa-alignment-summary-2026-08-22.md)。

## 归档内容

| 文档 | 类型 | 归档原因 |
|---|---|---|
| `capa-alignment-remediation-design-2026-08.md` | 修复设计 + 实施记录 | 已被 `capa-alignment-summary-2026-08-22.md` 取代 |
...
以下历史文档中的结论在后续调查中被推翻，**以 `capa-alignment-summary-2026-08-22.md` 为准**，请勿直接引用：
...
- `capa-alignment-summary-2026-08-22.md` —— **对标 CAPA 汇总报告**（含变更记录、能力全景、剩余差距、调查结论、待决策项）
