...
> The current `cluster-api-cce-controller:latest` digest is `a4384f56` (includes kubeconfig endpoint override + 429 back-off fix + cluster/node-pool `additionalTags`).
