...
> The current `cluster-api-cce-controller:latest` digest is `c5d01fba` (includes kubeconfig endpoint override + 429 back-off fix + cluster/node-pool `additionalTags`).
