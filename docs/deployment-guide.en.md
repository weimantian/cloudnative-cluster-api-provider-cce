...
> The current `cluster-api-cce-controller:latest` digest is `240837aa` (includes kubeconfig endpoint override + 429 back-off fix + cluster/node-pool `additionalTags`).
