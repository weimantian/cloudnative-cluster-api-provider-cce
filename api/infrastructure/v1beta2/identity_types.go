...
// pointer means any namespace — the contract).
...
// CCEClusterStaticIdentity is a reference to a static AK/SK Secret.
...
// identity — the CCE equivalent of an assumed-role identity. The agency
...
// CCEClusterRoleIdentity is a Huawei Cloud agency identity.
