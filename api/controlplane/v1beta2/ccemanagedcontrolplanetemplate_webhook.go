...
// +kubebuilder:webhook:path=/mutate-controlplane-cluster-x-k8s-io-v1beta2-ccemanagedcontrolplanetemplate,mutating=true,failurePolicy=fail,groups=controlplane.cluster.x-k8s.io,resources=ccemanagedcontrolplanetemplates,verbs=create;update,versions=v1beta2,name=mutation.ccemanagedcontrolplanetemplate.controlplane.cluster.x-k8s.io,sideEffects=None,admissionReviewVersions=v1
// +kubebuilder:webhook:path=/validate-controlplane-cluster-x-k8s-io-v1beta2-ccemanagedcontrolplanetemplate,mutating=false,failurePolicy=fail,groups=controlplane.cluster.x-k8s.io,resources=ccemanagedcontrolplanetemplates,verbs=create;update,versions=v1beta2,name=validation.ccemanagedcontrolplanetemplate.controlplane.cluster.x-k8s.io,sideEffects=None,admissionReviewVersions=v1
