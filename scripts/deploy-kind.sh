...
#      caBundle into the 14 admission webhooks (each uses a clientConfig block).
...
#   CCE_PROVIDER_VERSION=v0.1.3   provider version string for clusterctl
#
...
CCE_PROVIDER_VERSION="${CCE_PROVIDER_VERSION:-v0.1.3}"
